...
export const metadata: Metadata = {
  title: 'Reverse Mortgage Referral Partner Program | Earn $500 Per Referral',
  description: 'Join our referral network. Help clients access home equity while earning commission. Training and marketing support included.',
